...
loo_wtd_06_list = loo_wtd_07_list = loo_wtd_08_list = loo_wtd_09_list = loo_wtd_10_list
  loo_wtd_11_list = loo_wtd_12_list = loo_wtd_13_list = loo_wtd_14_list = loo_wtd_15a_list = 
    list()
...
for(ite in iter){
  ...
  sampest_tab_all[[ite]] = list(sampest_tab_01, sampest_tab_02, sampest_tab_03, sampest_tab_04, sampest_tab_05,
  ...
  popnest_summary_list[[ite]] = lapply(popnest_all_list[[ite]], function(x)quantile(x,c(0.05, 0.5, 0.95))) %>% 
    ...
    mutate(model = c(paste0('model0', 1:9),paste0('model', 11:15)), iter = ite)
  ...
  elpd_05_mat[ite,2] = loo_05list[[ite]]$estimates[1,2]
...
save(elpd_01_mat, elpd_02_mat, elpd_03_mat, elpd_04_mat, elpd_05_mat,
     elpd_06_mat, elpd_07_mat, elpd_08_mat, elpd_09_mat, elpd_10_mat, 
     elpd_11_mat, elpd_12_mat, elpd_13_mat, elpd_14_mat, elpd_15_mat,
     loo_wtd_01_list, loo_wtd_02_list, loo_wtd_03_list, loo_wtd_04_list,loo_wtd_05_list,
     loo_wtd_06_list, loo_wtd_07_list, loo_wtd_08_list, loo_wtd_09_list,loo_wtd_10_list,
     ...
     file="loo_base.RData", compress=T)
