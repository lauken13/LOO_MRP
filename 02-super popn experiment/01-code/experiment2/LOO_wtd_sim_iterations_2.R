...
for (i in 1:ITE){
  ...
  save(samp_data_list, sim_doub_list, prob_truth, coef_list, file="simulated100temp_2.RData")
}

save(samp_data_list, sim_doub_list, prob_truth, coef_list, file="simulated100_2.RData")
