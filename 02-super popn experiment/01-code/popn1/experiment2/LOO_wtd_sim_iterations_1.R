...
for (i in 1:ITE){
 ...
 sim_list[[i]] = cbind(loo_tab, loo_wtd_tab, loo_rank, loo_wtd_rank,
  ...
  save(samp_data_list, sim_list, prob_truth, coef_list, file="simulated100temp_1.RData")
}

save(samp_data_list, sim_list, prob_truth, coef_list, file="simulated100_1.RData")
