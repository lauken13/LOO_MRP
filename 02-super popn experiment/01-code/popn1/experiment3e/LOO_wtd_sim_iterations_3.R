...
for (i in 1:ITE){
 ...
 elpd_popnest_list[[length(elpd_popnest_list)+1]] = elpd_popnest_all
  ...
  save(elpd_popnest_list, samp_data_list, sim_trip_list, prob_truth, coef_list, file="simulated100temp_3.RData")
  
}

save(elpd_popnest_list, samp_data_list, sim_trip_list, prob_truth, coef_list, file="simulated100_3.RData")
