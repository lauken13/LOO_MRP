...
g = ggplot(ph, aes(x = total, y = model, group = iter, colour = model))+
  ...
  annotate("label", x = -7100, y = 13.5, label = "X2 and X4") +
...
g2 = ggplot(pu, aes(x = total, y = model, group = iter, colour = model))+
  ...
  annotate("label", x = -310, y = 13.5, label = "X2 and X4") +
  annotate("label", x = -200, y = 9.5, label = "X4 only") +
  annotate("label", x = -200, y = 5.5,  label = "X2 only") +
  annotate("label", x = -200, y = 2, label = "None") 
