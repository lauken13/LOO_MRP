...
g1 = ggplot(pc, aes(x = mean_pe, y = model, group = iter, colour = model))+
  ...
  annotate("label", x = 0.15, y = 19.5, label = "X2 and X4") +
  annotate("label", x = 0.15, y = 11.5, label = "X4 only") +
  annotate("label", x = 0.15, y = 6,  label = "X2 only") +
  annotate("label", x = 0.15, y = 2, label = "None") 
