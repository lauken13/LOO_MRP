...
g1 = ggplot(mm2, aes(x = value, y = model, group = model, color = model)) +
  ...
  xlim(0,0.2) + 
  annotate("label", x = 0.19, y = 19.5, label = "X2 and X4") +
  annotate("label", x = 0.19, y = 11.5, label = "X4 only") +
  annotate("label", x = 0.19, y = 6,  label = "X2 only") +
  annotate("label", x = 0.19, y = 2, label = "None")
