...
![](here::here(02-super popn approach/experiment1_baseWtdloo/02-results/plot_loo_raw_unwtd.png)){width=450px} ![](here::here(02-super popn approach/experiment1_baseWtdloo/02-results/plot_loo_raw_wtd.png)){width=450px}

![](here::here(02-super popn approach/experiment1_baseWtdloo/02-results/plot_loop.png)){width=450px}
...
![](here::here(02-super popn approach/experiment1_baseWtdloo/02-results/plot_mrp_truth.png)){width=450px} ![](here::here(02-super popn approach/experiment1_baseWtdloo/02-results/plot_mrp_qt_range.png)){width=450px}
...
We were expecting to see models with $X_2$ and $X_4$ getting picked up when using `loo` and `wtd_loo`, but we were getting mixed results. We then tried to fix the multiplier when generating our random effects. 
...
Even after fixing the multiplier, we were still getting inconclusive results across the models. So we moved on to a super population approach by sampling a different population each time. 
