...
<center>
![](images/2b/prob_truth.png){width=300px}
</center>
...
![](images/2b/plot_loo_raw_unwtd.png){width=450px} ![](images/2b/plot_loo_raw_wtd.png){width=450px}

![](images/2b/plot_loop.png){width=450px}
...
![](images/2b/plot_mrp_truth.png){width=450px} ![](images/2b/plot_mrp_qt_range.png){width=450px}
